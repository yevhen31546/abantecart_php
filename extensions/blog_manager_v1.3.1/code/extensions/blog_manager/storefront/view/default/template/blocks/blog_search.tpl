...
<?php } ?>
<form id="blog_search_form" class="form-search">
    
    <div class="btn-group search-bar">
    	<input type="text" id="blog_keyword" name="blog_keyword" autocomplete="off"
    		   class="pull-left form-control" placeholder="<?php echo $text_blog_search; ?>" value=""
    		   class="btn dropdown-toggle" href="#" />
