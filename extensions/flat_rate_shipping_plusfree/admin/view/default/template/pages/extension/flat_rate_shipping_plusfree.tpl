...
<div id="content" class="panel panel-default">
	...
	<div class="panel-body panel-body-nopadding tab-content col-xs-12">
		...
		// rates for locations
		$field_names = array('status','rate','freecost','tax_id');
		foreach($locations as $location){
            ...
            <div class="form-group">
				<label class="control-label col-sm-3 col-xs-12 h4 heading" for="editFrm_<?php echo $status; ?>"><?php echo $location['name']; ?></label>
			...
			<div class="form-group">
				<label class="control-label col-sm-3 col-xs-12" for="editFrm_<?php echo $freecost; ?>"><?php echo $entry_freecost; ?></label>
				<div class="input-group afield col-sm-3 col-xs-12 ml_ckeditor">
					<?php echo $form['fields']['rates'][$freecost]; ?>
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-3 col-xs-12" for="editFrm_<?php echo $tax_id; ?>"><?php echo $entry_tax; ?></label>
				<div class="input-group afield col-sm-3 col-xs-12 ml_ckeditor">
					<?php echo $form['fields']['rates'][$tax_id]; ?>
				</div>
			</div>
