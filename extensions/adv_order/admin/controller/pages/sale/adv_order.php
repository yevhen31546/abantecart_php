...
class ControllerPagesSaleAdvOrder extends AController{
public $data = array ();
	public $error = array ();
	...
	public function main(){
		...
		$grid_settings = array (
			...
			// url to load data from
				...
				'dataurl'		=> $this->html->getSecureURL('listing_grid/order/getorders'),
		...
		//, 'payment_method', 'payment_postcode', 'payment_address_1', 'shipping_address_1'
		$grid_settings['colNames'] = array (
				...
				$this->language->get('Payment Method'),
				$this->language->get('Shipping Method'),
				$this->language->get('AVS'),
				$this->language->get('Billing Address'),
				$this->language->get('Shipping Address'),
				$this->language->get('Products Ordered'),
		);
		$grid_settings['colModel'] = array (
				...
				array (
						...
						'index' => 'payment_address_1',
						'width' => 140,
						'align' => 'center'
				),
				array (
						'name'  => 'shipping_address',
						'index' => 'shipping_address_1',
						'width' => 140,
						'align' => 'center'
				),
				array (
	...
	public function files(){
		...
		$this->data['action'] = $this->html->getSecureURL('sale/order/files',
				'&order_id=' . $this->request->get['order_id']);
		$this->data['cancel'] = $this->html->getSecureURL('sale/order');
		...
		$this->data['update'] = $this->html->getSecureURL('listing_grid/order/update_field',
