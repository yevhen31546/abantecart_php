...
<div id="product_details">
	<div class="row">
					...
					<ul class="thumbnails mainimage smallimage">
						<?php if (sizeof($images) > 1){
							...
							foreach ($images as $image){
								?><li class="producthtumb" align="left"><?php
									if ($image['origin'] != 'external'){?>
										<a href="Javascript:void(0);" data-href="<?php echo $image['main_url']; ?>"
										   data-standard="<?php echo $image['thumb2_url']; ?>"
										><img style="vertical-align:middle;width: <?php echo $add_w; ?>px; height: <?php echo $add_h; ?>px;"
		...
		<div class="col-md-6">
			<div class="row">
				<div class="col-md-12">
					<h1 class="productname"><span class="bgnone"><?php
						if (stristr($heading_title,$model)<>false) { $heading_title = str_ireplace($model,'', $heading_title); }
						echo '<DIV style="width:99%;">'. str_ireplace('iSpring', 'iSpring '. $model, $heading_title) .'</DIV>';
					?></span></h1>
					<span class="blurb"><?php
					//~ echo str_replace('&gt;','>',str_replace('&lt;','<',$product_info['blurb']))
					echo '<DIV style="width:99%;">'. html_entity_decode($product_info['blurb']) .'</DIV>';
					?></span>
							...
							<ul class="rate">
								...
								for ($i = 1; $i <= 5; $i++){
									if ($i <= $average){
										...
										echo '<li class="off"></li> '. $tab_review;
									}
								}
								?>
							</ul>
						...
						<?php if ($display_price) { ?>
								...
								<fieldset>
									...
									<div class="mt20 ">
										...
										&nbsp;&nbsp;&nbsp;&nbsp;Eligible for FREE Shipping Orders Over $35 within US 48 cont. states <a target=_blank href="shipping">Details</a> &nbsp;&nbsp;
										<?php } ?>
										<?php } else { ?>
		...
		<div class="col-md-12 productdesc">
			...
			<div class="tab-content">
				...
				<div class="tab-pane active" id="description">
					<?php //echo '<CENTER><TABLE><TR><TD>'. str_replace('http:','https:',str_replace('catalog/advanced_search_result.php?keywords=','ac/index.php?rt=product/search&model=1&keyword=',$description)) .'</TD></TR></TABLE></CENTER>'; ?>
					<?php echo '<table>'. $description .'</table>' ; ?>
